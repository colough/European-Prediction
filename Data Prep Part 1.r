...
"Football Predictions/England/Raw Data/Aggregated")
setwd(file_location)

df <- read.csv("Aggregated_Raw_Data_England.csv", header=T)
df <- as.data.table(df)
colnames(df)[2] <- "Game_Week_Index"
...
df[,Home_Shot_Percentage_Form := Average_Form_Calc(Form_Length,Season,Game_Week_Index,
                    Team_Result, HomeTeam, AwayTeam, Form_Var, Home_Form, df)]
df[,Away_Shot_Percentage_Form := 0L]
Form_Var2 <- quote(Home_Shot_Percentage)
Form_Var1 <- quote(Away_Shot_Percentage)
df[,Away_Shot_Percentage_Form := Average_Form_Calc(Form_Length,Season,Game_Week_Index,
                    Team_Result, AwayTeam, HomeTeam, Form_Var, Home_Form, df)]
...
df[,Home_Shot_Conversion_Form := Average_Form_Calc(Form_Length,Season,Game_Week_Index,
                    Team_Result, HomeTeam, AwayTeam, Form_Var, Home_Form, df)]
df[,Away_Shot_Conversion_Form := 0L]
Form_Var2 <- quote(Home_Shots_Conversion)
Form_Var1 <- quote(Away_Shots_Conversion)
df[,Away_Shot_Conversion_Form := Average_Form_Calc(Form_Length,Season,Game_Week_Index,
                    Team_Result, AwayTeam, HomeTeam, Form_Var, Home_Form, df)]
df[,Home_Conversion_Offset := 0.0]
df$Home_Conversion_Offset <- as.double(df$Home_Conversion_Offset)
df[Home_Shot_Conversion_Form > 0, Home_Conversion_Offset := Home_Shots_Conversion
                                                    / Home_Shot_Conversion_Form]
df[,Away_Conversion_Offset := 0.0]
df$Away_Conversion_Offset <- as.double(df$Away_Conversion_Offset)
df[Away_Shot_Conversion_Form > 0, Away_Conversion_Offset := Away_Shots_Conversion
                                                    / Away_Shot_Conversion_Form]
df[,Home_Conversion_Offset_Form := 0L]
Form_Var1 <- quote(Home_Conversion_Offset)
Form_Var2 <- quote(Away_Conversion_Offset)
df[,Home_Conversion_Offset_Form := Average_Form_Calc(Form_Length,Season,Game_Week_Index,
                    Team_Result, HomeTeam, AwayTeam, Form_Var, Home_Form, df)]
