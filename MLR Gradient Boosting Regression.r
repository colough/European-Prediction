...
#- ok so this is the meat of the action where for every team we...
		 ...
		 #- and for every gameweek
			...
			ModTrain1 <- train[train$Team == Teams[1,1] & train$Game.Week.Index > 6 & train$Season != "2015 2016",]
			ModTrain2 <- train[train$Team == Teams[1,1] & train$Game.Week.Index > 6 & train$Game.Week.Index < 10 & train$Season == "2015 2016",]
			...
			PredData <- train[train$Team == Teams[1,1] & train$Game.Week.Index == 10 & train$Season == "2015 2016",]
